...
- Sync alerts to iPhone/iPad via Apple Reminders: optionally copy privacy-safe learning alerts into an Apple Reminders list named `Learning Boost`; iCloud can sync those reminders to your iPhone, iPad, and other Macs if your system settings allow it.
