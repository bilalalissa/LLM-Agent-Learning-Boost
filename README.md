...
- [Learning Flow and Notifications](docs/learning-flow-and-notifications.md): detailed guide to Autopilot, dated timeline, tab loading states, source processing, bits/cards, read state, aggregate plans/goals, safety gates, and macOS notifications.
